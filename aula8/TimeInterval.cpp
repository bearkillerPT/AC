...
int TimeIntervalCompare(TimeInterval *ti1, TimeInterval *ti2) {
  int res = DateTimeCompare(ti1->end, ti2->start);
  if(res < 0) return res;
  res = DateTimeCompare(ti1->start, ti2->end);
  if(res > 0) return res;
  return 0;
}
...
int TimeIntervalContains(TimeInterval *ti1, TimeInterval *ti2) {
  if(DateTimeCompare(ti1->start, ti2->start) <= 0 && DateTimeCompare(ti1->end, ti2->end) >= 0) return 1;
  return 0;
